      ...
      <div className="max-w-full px-4">
        ...
        <div className="bg-white shadow-md rounded-lg p-4 mb-6 sticky top-16 z-30">
          <div className="flex flex-wrap gap-4 items-end">
            ...
            {/* Reset */}
            <div className="flex flex-col gap-1">
              <label className="text-xs font-medium text-gray-700 uppercase tracking-wide opacity-0">
                Reset
              </label>
              <button
                onClick={handleReset}
              ...
              <div className="max-h-[calc(100vh-400px)] overflow-y-auto">
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <thead className="bg-gray-50 sticky top-0 z-10">
                    <tr>
                      <th
                        className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase cursor-pointer hover:bg-gray-100 select-none bg-gray-50"
